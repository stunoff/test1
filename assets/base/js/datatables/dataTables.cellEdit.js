...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    if (table != null) {
        ...
        $(table.body()).on('click', 'td', function () {
            ...
            // добавил if чтоб не редактировался первый столбец
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "undefined-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='" + oldValue + "'></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Отмена</a> ";
            break;
        case "textarea": 
        ...
        default: // text input
            ...
            input.html = "<textarea id='ejbeatycelledit' class='" + inputCss + "'>"+oldValue+"</textarea><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'><br>Подтвердить</a><br> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Отмена</a>";
            break;
    }
    return input;
}
...
function adjustHeight(ctrl) {
    $(ctrl).css({'height':'auto','overflow-y':'hidden', 'width': '100%'}).height(ctrl.scrollHeight);
}

$('.table').on('focus', '#ejbeatycelledit', function () {
